...
<body onload="window.print()">
    ...
    <div class="text-center">
        ...
        <p>{{ strtoupper($setting->telephone) }}</p>
    </div>
    <br>
    <div>
    ...
    <p class="text-center">No: {{ tambah_nol_didepan($penjualan->id_penjualan, 10) }}</p>
    ...
    <table width="100%" style="border: 0;">
        ...
        <tr>
            <td>Layanan:</td>
            <td class="text-right">{{ format_uang($penjualan->biaya_resep) }}</td>
        </tr>
        <tr>
            <td>Total Bayar:</td>
    ...
    <p class="text-center">
        {{ strtoupper($setting->nota_foot_note) }}
    </p>
